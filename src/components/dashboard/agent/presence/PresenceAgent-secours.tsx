...
export default function AgentDashPresence() {
    const { data: todayPresenceRaw = [], isPending: isPendingTodayPresence, refetch: refetchToday } = useGet(['PresenceToDay'], GetPresence)
    ...
    const todayPresence = Array.isArray(todayPresenceRaw) ? (todayPresenceRaw as Presence[]) : []
                ...
                <CardContent>
                    <Table>
                        ...
                        <TableBody>
                            {
                                todayPresence ?
                                    todayPresence.map((item: Presence) => (
