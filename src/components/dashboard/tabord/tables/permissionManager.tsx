...
const ACTION_LABELS: Record<string, string> = {
  ...
  delete: "Supprimer",
  sign: "Signer",
  signal_absence: "Signaler une absence",
  confirm: "Confirmer",
  validate: "Valider",
  request: "Demander",
  publish: "Publier",
...
export default function PermissionManager() {
  ...
  const assignablePermissions = Array.isArray(rolePermissionResponse?.data?.permissions)
    ? rolePermissionResponse.data.permissions
    : [];
  ...
  async function handleSaveRole(roleId: number) {
    const response: any = await updateRolePermissions({
      roleId,
      permissionIds: roleSelections[roleId] ?? [],
    });
    ...
    <div className="flex flex-col gap-6 px-4 py-3">
          ...
          <div className="mb-4 flex items-center justify-between gap-3">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Catalogue defini par le developpeur. L'administrateur le consulte et l'attribue aux roles.
              </p>
            </div>
            <Button
              type="button"
        ...
        <div className="min-w-0 overflow-hidden rounded-xl border bg-background p-4">
          ...
          <div className="mt-3 space-y-3">
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              <p>Le nom du role est libre. Il depend du vocabulaire de l'entreprise.</p>
              <p>Les permissions sont definies par le developpeur, puis attribuees aux roles par l'administrateur.</p>
            </div>
          </div>
      ...
      <div className="rounded-xl border bg-background p-4">
        <div className="mb-4">
          ...
          <p className="text-sm text-muted-foreground">
            Chaque role peut recevoir exactement les permissions necessaires.
          </p>
        </div>
